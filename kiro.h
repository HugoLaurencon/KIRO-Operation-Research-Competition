...
vector<vector<vector<node>>> change_loop_randomly(vector<vector<vector<node>>> best_data, int n, vector<int> distances, int indice, int lenght_loop = 0);

vector<vector<vector<node>>> heuristic_change_loop_randomly(vector<vector<vector<node>>> clusters, vector<node> distribution, vector<node> terminal, vector<int> D, int rep, string name, bool CC = false);
...
vector<vector<vector<node>>> heuristic_neighbor(vector<vector<vector<node>>> initial_solution, vector<node> distribution, vector<node> terminal, vector<int> D, int rep, int iterations, string name, bool CC = false);

vector<vector<vector<node>>> heuristic_neighbor_multiple_times(vector<vector<vector<node>>> initial_solution, vector<node> distribution, vector<node> terminal, vector<int> D, int rep, int k, int iterations, string name, bool CC = false);
